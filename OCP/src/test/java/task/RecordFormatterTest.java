...
public class RecordFormatterTest {
    ...
    public void formatAddress() {
        ...
        aRec.setIndex("61000");
        String fmt = aRec.printAll();
        assertThat(aRec.printAll(), is("address: Ukraine, Kharkivska, Kharkiv, 23 Serpnya st., 33 b., N/A apt., 61000"));
    }
